...
export const FOOD_DB = {
  ...
  protein: {
    ...
    foods: [
      ...
      { id: 'whey',             name: '蛋白粉',     unit: '勺',    size: '30g/勺（1 份）',            carbs: 3,   protein: 24, fat: 1  },
      // === 东北菜/菜单补充 ===
      { id: 'ribs',             name: '排骨',       unit: '块',    size: '100g/块（带骨·含 50g 肉）',  carbs: 0,   protein: 18, fat: 12 },
      { id: 'lamb',             name: '羊肉',       unit: '100g',  size: '100g（羊里脊·瘦）',           carbs: 0,   protein: 19, fat: 13 },
      { id: 'chicken_wing_mid', name: '鸡翅中',     unit: '个',    size: '30g/个',                       carbs: 0,   protein: 6,  fat: 2.5},
      { id: 'century_egg',      name: '皮蛋',       unit: '个',    size: '60g/个（松花皮蛋）',           carbs: 1,   protein: 7,  fat: 9  },
      { id: 'cured_pork',       name: '咸肉',       unit: '块',    size: '100g/块（腌笃鲜用）',         carbs: 1,   protein: 18, fat: 36 },
    ],
  },
  fat: {
    label: '脂肪',
    ...
    foods: [
      { id: 'oil',           name: '山茶油',   unit: '勺',   size: '10g/勺（约10ml）',   carbs: 0,  protein: 0,  fat: 10 },
  ...
  vegetable: {
    ...
    foods: [
      ...
      // === 东北菜/菜单补充（袪装/卤品/香口常客） ===
      { id: 'shiitake',     name: '香菇',       unit: '朵',   size: '50g/朵（中等·干重 5g）',   carbs: 2.5, protein: 1,   fat: 0.2},
      { id: 'wood_ear',     name: '木耳',       unit: '碗',   size: '50g/碗（干重·泡发后约 200g）', carbs: 3, protein: 0.5, fat: 0.1},
      { id: 'bamboo_shoot', name: '春笋',       unit: '根',   size: '200g/根（剥壳后）',         carbs: 7,   protein: 4,   fat: 0.3 },
      { id: 'tofu_skin_knot', name: '百叶结',   unit: '个',   size: '20g/个（豆腐皮打结）',      carbs: 0.4, protein: 3,   fat: 1.5 },
      { id: 'green_bean',     name: '豆角',     unit: '把',   size: '100g/把（炒一碗）',         carbs: 7,   protein: 2,   fat: 0.2 },
      { id: 'garlic_sprout',  name: '蒜薹',     unit: '把',   size: '100g/把（炒一盘）',         carbs: 8,   protein: 2,   fat: 0.3 },
      { id: 'long_jing',      name: '龙井菜',   unit: '把',   size: '100g/把（江浙春日菜）',     carbs: 3,   protein: 2,   fat: 0.2 },
    ],
  },
  // ========================================================
  ...
  fruit: {
    ...
    foods: [
      { id: 'apple',       name: '苹果',       unit: '个',  size: '200g/个（中果·成年人拳头）',  carbs: 14,   protein: 0.3, fat: 0.2 },
      { id: 'banana',      name: '香蕉',       unit: '根',  size: '120g/根（中等·去皮）',        carbs: 27,   protein: 1.3, fat: 0.4 },
      { id: 'orange',      name: '橙子',       unit: '个',  size: '200g/个（中等·去皮）',        carbs: 24,   protein: 1.8, fat: 0.2 },
      { id: 'strawberry',  name: '草莓',       unit: '10颗', size: '100g/10颗（大果）',          carbs: 7.7,  protein: 0.7, fat: 0.3 },
      { id: 'blueberry',   name: '蓝莓',       unit: '盒',  size: '100g/盒（1小盒）',            carbs: 14.5, protein: 0.7, fat: 0.3 },
      { id: 'mango',       name: '芒果',       unit: '个',  size: '300g/个（大果·去核去皮）',     carbs: 45,   protein: 2.4, fat: 1.2 },
      { id: 'lemon',       name: '柠檬',       unit: '个',  size: '80g/个（中等）',              carbs: 7.2,  protein: 0.9, fat: 0.2 },
      { id: 'grapefruit',  name: '西柚',       unit: '个',  size: '300g/个（大果）',              carbs: 24,   protein: 2.1, fat: 0.3 },
      { id: 'passion_fruit', name: '百香果',   unit: '个',  size: '50g/个（中等）',               carbs: 11.5, protein: 1.1, fat: 0.4 },
      { id: 'grape',       name: '葡萄',       unit: '10颗', size: '100g/10颗（中等）',          carbs: 10,   protein: 0.7, fat: 0.2 },
      { id: 'peach',       name: '桃子',       unit: '个',  size: '200g/个（中等）',              carbs: 22,   protein: 1.8, fat: 0.6 },
      { id: 'watermelon',  name: '西瓜',       unit: '块',  size: '500g/块（厚切·去皮）',         carbs: 38,   protein: 3,   fat: 1   },
      { id: 'kiwi',        name: '猕猴桃',     unit: '个',  size: '100g/个（中等）',              carbs: 14.7, protein: 1.1, fat: 0.5 },
      { id: 'dragon_fruit',name: '火龙果',     unit: '个',  size: '400g/个（红心·去皮）',         carbs: 52,   protein: 4.8, fat: 0   },
      { id: 'pineapple',   name: '菠萝',       unit: '块',  size: '200g/块（去皮去眼）',         carbs: 26,   protein: 1,   fat: 0.2 },
      { id: 'pear',        name: '梨',         unit: '个',  size: '200g/个（中等）',              carbs: 20,   protein: 0.8, fat: 0.2 },
    ],
  },
  ...
  dishes: {
    ...
    foods: [
      ...
      { id: 'braised_pork',   name: '红烧肉',         unit: '份',   size: '100g/份（五花肉·微甜）',   carbs: 5,  protein: 25, fat: 42 },
      { id: 'stir_greens',    name: '清炒时蔬',       unit: '份',   size: '200g/份（一盘青菜）',       carbs: 8,  protein: 3,  fat: 5  },
      { id: 'boiled_fish',    name: '水煮鱼',         unit: '份',   size: '500g/份（带汤·多油）',      carbs: 8,  protein: 45, fat: 28 },
      { id: 'guobaorou',      name: '锅包肉',         unit: '份',   size: '100g/份（裹糖醋·东北）',   carbs: 16, protein: 45, fat: 43 },
      { id: 'disanxian',      name: '地三鲜',         unit: '份',   size: '130g/份（炸后烩）',         carbs: 35, protein: 8,  fat: 30 },
      { id: 'yuxiang_pork',   name: '鱼香肉丝',       unit: '份',   size: '200g/份',                  carbs: 15, protein: 20, fat: 14 },
      { id: 'yanduxian',      name: '腌笃鲜',         unit: '份',   size: '500g/份（汤主）',          carbs: 8,  protein: 35, fat: 20 },
      { id: 'braised_ribs',   name: '红烧排骨',       unit: '份',   size: '125g/份（带骨肉）',         carbs: 10, protein: 50, fat: 70 },
      { id: 'ribs_rice',      name: '排骨烱饭',       unit: '份',   size: '400g/份（排骨+米饭）',      carbs: 80, protein: 35, fat: 28 },
      { id: 'kungpao',        name: '宫保鸡丁',       unit: '份',   size: '200g/份（鸡胸为主）',      carbs: 15, protein: 25, fat: 22 },
      { id: 'mapo_tofu',      name: '麻婆豆腐',       unit: '份',   size: '300g/份（麻辣·1 盒豆腐）', carbs: 12, protein: 22, fat: 14 },
      { id: 'sweet_sour_pork',name: '糖醋里脊',       unit: '份',   size: '100g/份（裹糖醋汁）',      carbs: 50, protein: 22, fat: 45 },
      { id: 'potato_pancake', name: '土豆丝卷饼',     unit: '份',   size: '200g/份（1 张饼）',         carbs: 60, protein: 12, fat: 18 },
      { id: 'sandwich',       name: '三明治',         unit: '个',   size: '200g/个（4 片吐司）',      carbs: 40, protein: 18, fat: 18 },
      { id: 'cola_wings',     name: '可乐鸡翅',       unit: '份',   size: '300g/份（10 个翅中）',     carbs: 35, protein: 35, fat: 30 },
      { id: 'egg_fried_rice', name: '蛋炒饭',         unit: '份',   size: '300g/份（2 碗饭+2 蛋）',   carbs: 60, protein: 15, fat: 20 },
      { id: 'tomato_beef',    name: '西红柿炖牛腩',   unit: '份',   size: '500g/份（牛腩+番茄）',      carbs: 15, protein: 45, fat: 35 },
      { id: 'cumin_lamb',     name: '孜然羊肉',       unit: '份',   size: '250g/份（羊里脊）',         carbs: 8,  protein: 35, fat: 38 },
      { id: 'mushroom_chicken', name: '香菇滑鸡',     unit: '份',   size: '300g/份（鸡腿+香菇）',     carbs: 10, protein: 30, fat: 18 },
      { id: 'poached_egg',    name: '荷包蛋',         unit: '个',   size: '50g/个（溏心）',            carbs: 0.5,protein: 7,  fat: 7  },
      { id: 'cucumber_egg_soup', name: '黄瓜皮蛋汤',  unit: '份',   size: '400g/份（黄瓜+2 皮蛋）',   carbs: 6,  protein: 10, fat: 8  },
      { id: 'jingj_rousi',     name: '京酱肉丝',     unit: '份',   size: '200g/份（豆腐皮+肉丝）',  carbs: 14, protein: 22, fat: 14 },
      { id: 'ganbian_doujiao', name: '干煸豆角',     unit: '份',   size: '200g/份（豆角+肉末）',    carbs: 18, protein: 14, fat: 16 },
      { id: 'doujiao_menmian', name: '豆角焖面',     unit: '份',   size: '400g/份（豆角+面条）',    carbs: 70, protein: 18, fat: 14 },
    ],
  },
  // ========================================================
  ...
  drink: {
    ...
    foods: [
      { id: 'rum',       name: '白朗姆酒',   unit: 'shot', size: '45ml/shot（1 杯烈酒）',       carbs: 0,    protein: 0, fat: 0 },
      { id: 'vodka',     name: '伏特加',     unit: 'shot', size: '45ml/shot',                  carbs: 0,    protein: 0, fat: 0 },
      { id: 'gin',       name: '金酒',       unit: 'shot', size: '45ml/shot',                  carbs: 0,    protein: 0, fat: 0 },
      { id: 'whiskey',   name: '威士忌',     unit: 'shot', size: '45ml/shot（波本为主）',       carbs: 0,    protein: 0, fat: 0 },
      { id: 'tequila',   name: '龙舌兰',     unit: 'shot', size: '45ml/shot',                  carbs: 0,    protein: 0, fat: 0 },
      { id: 'cointreau', name: '君度橙酒',   unit: 'shot', size: '30ml/shot（甘甜·含 7g 糖）', carbs: 7,    protein: 0, fat: 0 },
    ],
  },
  // ========================================================
  ...
  seasoning: {
    ...
    foods: [
      { id: 'soy_sauce',     name: '生抽',       unit: '勺',  size: '10ml/勺',  carbs: 0.5, protein: 0.8, fat: 0   },
      { id: 'dark_soy',      name: '老抽',       unit: '勺',  size: '10ml/勺',  carbs: 1,   protein: 0.5, fat: 0   },
      { id: 'oyster_sauce',  name: '蚝油',       unit: '勺',  size: '10g/勺',   carbs: 2.5, protein: 0.5, fat: 0.1 },
      { id: 'doubanjiang',   name: '豆瓣酱',     unit: '勺',  size: '10g/勺',   carbs: 3,   protein: 2,   fat: 1   },
      { id: 'huangdoujiang', name: '黄豆酱',     unit: '勺',  size: '10g/勺',   carbs: 3,   protein: 2,   fat: 1.5 },
      { id: 'ketchup',       name: '番茄酱',     unit: '勺',  size: '10g/勺',   carbs: 2,   protein: 0.1, fat: 0   },
      { id: 'sugar',         name: '白砂糖',     unit: '勺',  size: '10g/勺',   carbs: 10,  protein: 0,   fat: 0   },
    ],
  },
};
...
// 从 size 字段提取克数（如 "150g/碗" → 150）
export function parseSizeG(size) {
  if (!size) return 100;
  const m = String(size).match(/(\d+(?:\.\d+)?)\s*g/i);
  if (m) return parseFloat(m[1]);
  // 体积单位：1ml ≈ 1g
  const ml = String(size).match(/(\d+(?:\.\d+)?)\s*ml/i);
...
export function per100g(food) {
  ...
  const sizeG = parseSizeG(food.size);
