...
const QUICK_TARGETS = {
  training: {
    ...
    foods: [
      ...
      { id: 'chicken_breast', qty: 4,   meal: 'lunch' },
      { id: 'rice',           qty: 1.5, meal: 'dinner' },
      { id: 'chicken_breast', qty: 3,   meal: 'dinner' },
  ...
  rest: {
    ...
    foods: [
      ...
      { id: 'oil',            qty: 0.5, meal: 'breakfast' },
      { id: 'rice',           qty: 1,   meal: 'lunch' },
      { id: 'chicken_breast', qty: 4,   meal: 'lunch' },
      { id: 'oil',            qty: 0.5, meal: 'lunch' },
      { id: 'rice',           qty: 2,   meal: 'dinner' },
